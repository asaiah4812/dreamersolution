...
const Button = ({text, href}:{text:string; href:string;}) => {
    return (
      <>
        <Link href={href} className="group relative inline-flex h-12 items-center text-center justify-center overflow-hidden rounded-md border-2 border-[#394481]  font-medium">
          <div className="inline-flex h-12 translate-y-0 items-center justify-center px-6  bg-gradient-to-r  dark:text-white text-black transition duration-500 group-hover:-translate-y-[150%]">
           {text}
          </div>
