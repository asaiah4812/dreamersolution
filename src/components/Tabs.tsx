    ...
    <div className="border bg-white/1 backdrop-blur-sm rounded-md p-4  relative">
      <TabsProvider defaultValue={'design'}>
        ...
        <TabsContent value="collaborate">
          <Link href={'https://dreameracademy.vercel.app'} className="w-full">
            <Image
              src={
                '/image.png'
              }
        ...
        <TabsContent value="share">
          <Link href={'https://www.figma.com/proto/xJNhFErimwkotAyJtBGgeB/Backspace-Cash?page-id=0%3A1&node-id=11-2&starting-point-node-id=11%3A2&t=nOFqjT7d47vpEKdn-1'} className="w-full">
            <Image
              src={
                '/crypto.png'
              }
        ...
        <TabsContent value="publish">
          <Link href={'https://dreamer-blog.vercel.app'} className="w-full">
            <Image
              src={
                '/blog.png'
              }
